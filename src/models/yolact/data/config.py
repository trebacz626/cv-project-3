...
live_cell = dataset_base.copy({
    'name': 'LiveCell',

    'train_images': '../../../data/LiveCell/images/livecell_train_val_images',
    'train_info':   '../../../data/LiveCell/livecell_coco_train.json',

    'valid_images': '../../../data/LiveCell/images/livecell_train_val_images',
    'valid_info':   '../../../data/LiveCell/livecell_coco_val.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': trash_can,
    'num_classes': len(trash_can.class_names) + 1,
